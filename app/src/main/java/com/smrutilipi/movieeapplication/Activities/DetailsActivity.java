...
public class DetailsActivity extends AppCompatActivity {
    ...
    private void fetchMovieDetails(String imdbID) {
        ...
        JsonObjectRequest request = new JsonObjectRequest(JsonObjectRequest.Method.GET,
                Constants.DETAILS_URL + imdbID + Constants.ENDPOINT_URL,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            reviews.setText("Reviews:" + response.getString("imdbRating"));
                            synopsis.setText("Synopsis:" + response.getString("Plot"));
                            score.setText("Score:" + response.getString("Metascore"));
                            popularity.setText("Popularity:" + response.getString("imdbVotes"));
